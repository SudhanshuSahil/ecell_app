...
INVALID_PASSWORD = "The password does not fits in the criteria"
USER_NOT_REGISTERED="The given user doesn't exist. Make sure you are using correct email and Esummit ID"