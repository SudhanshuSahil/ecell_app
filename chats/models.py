...
class Chat(ActiveModel):
	# id = models.UUIDField(primary_key=True, default=uuid4, editable=False)
	chat_id = models.AutoField(primary_key=True)
	# str_id = models.CharField(max_length=58, editable=False, null=True)
	# time_of_creation = models.DateTimeField(auto_now_add=True)
	message = models.TextField(blank=True)
	from_friend = models.ForeignKey(Friend, blank=True, null=True, on_delete=models.SET_NULL)
	# to_friend = models.ManyToManyField(Friend)
	# to_name = models.CharField(max_length=500, blank=True, null=True, default=None, editable=False)
	from_name = models.CharField(max_length=500, blank=True, null=True, default=None, editable=False)
	...
	def save(self, *args, **kwargs):
		# self.to_name = self.to_friend.name
		self.from_name = self.from_friend.name
